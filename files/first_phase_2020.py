...
import PyPDF2
file = open("../pdfs/TSEAMCET_2020_LASTRANKS_FIRSTPHASE.pdf", "rb")
...
for page_number in range(file.numPages):
    ...
    ninth_index_errors = ["INTELLIGENCE AND MACHINE LEARNING)", "TECHNOLOGY", "SYSTEMS", "ENGINEERING", "TECHNOLOGY)"]
